...
//                [self manualLogin];
            ...
            {
                [[AppPreferences sharedAppPreferences] showAlertViewWithTitle:nil withMessage:NO_INTERNET_DETAIL_MESSAGE withCancelText:nil withOkText:@"OK" withAlertTag:1000];
            }
        }
